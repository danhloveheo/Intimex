(function ($) {
    ...
    var MultiSelectBox = DropDownList.extend({
        ...
        options: {
            ...
            allText: "Tất cả", // select All text
            fitler: "contains",
        ...
        _addSelectAllItem: function () {
            ...
            if (firstListItem.length > 0) {
                ...
                selectAllData[this.options.dataTextField] = this.options.allText;
        ...
        _selectItems: function (listItems) {
            ...
            $.each(listItems, function (i, item) {
                ...
                that.select($(that.items()[idx]));  // select OR unselect
            });
        },
        ...
        _updateSummary: function (itemsText) {
            ...
            if (itemsText.length <= this.options.preSummaryCount) {
                ...
                this._textAccessor('Bạn đã chọn ' + itemsText.length + '/' + this._getAllValueListItems().length);
            }
        },
...
//                var selectAllData = {};
//                selectAllData[this.options.dataValueField] = '*';
//                selectAllData[this.options.dataTextField] = 'Tất cả';
